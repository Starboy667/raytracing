...
//  Expose selected render state for draw callbacks to use. Access in
...
//  ImGuiPlatformIO interface. 2024-10-07: Vulkan: Changed default texture
//  sampler to Clamp instead of Repeat/Wrap. 2024-10-07: Vulkan: Expose selected
...
bool ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info) {
    ...
    if (info->UseDynamicRendering) {
        ...
        ImGuiImplVulkanFuncs_vkCmdBeginRenderingKHR =
            reinterpret_cast<PFN_vkCmdBeginRenderingKHR>(vkGetInstanceProcAddr(
                info->Instance, "vkCmdBeginRenderingKHR"));
        ImGuiImplVulkanFuncs_vkCmdEndRenderingKHR =
            reinterpret_cast<PFN_vkCmdEndRenderingKHR>(
