...
//
// Adapted from Dear ImGui Vulkan example and Walnut
//
...
void Application::Init() {
    ...
    _window = glfwCreateWindow(1280, 720, "Raytracer", NULL, NULL);
    ...
    VkResult err =
        glfwCreateWindowSurface(g_Instance, _window, g_Allocator, &surface);
    check_vk_result(err);
...
void Application::Run() {
    ...
    while (!glfwWindowShouldClose(_window)) {
        ...
        // pair to create a named window.
        {
            ...
            /*{
                ...
                ImGui::ColorEdit3("clear color",
                                  (float*)&background_color);  // Edit 3 floats
                                                               // representing a
                // color
        ...
        //                                 // button that will clear the bool
        //                                 when
        //                                 // clicked)
...
void Application::Shutdown() {
    // Cleanup
    VkResult _err = vkDeviceWaitIdle(g_Device);
    check_vk_result(_err);
